...
export default {
  ...
  models: [
    ...
    { id: "gemini-3.1-flash-lite-preview", name: "Gemini 3.1 Flash Lite (Newest, Free)", params: ["language","prompt"], kind: "stt" },
    { id: "gemini-3-flash-preview", name: "Gemini 3 Flash (Free)", params: ["language","prompt"], kind: "stt" },
    { id: "gemini-2.5-flash", name: "Gemini 2.5 Flash (Free)", params: ["language","prompt"], kind: "stt" },
    { id: "gemini-2.5-flash-lite", name: "Gemini 2.5 Flash Lite (Cheapest)", params: ["language","prompt"], kind: "stt" },
    { id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro (Best)", params: ["language","prompt"], kind: "stt" },
    { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro", params: ["language","prompt"], kind: "stt" },
